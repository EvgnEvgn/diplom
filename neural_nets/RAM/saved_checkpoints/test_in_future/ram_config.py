class RAM_Config(object):
    def __init__(self, batch_size, max_epochs, num_classes, nGlimpses=6, translated=False):
        ...
        self.save_dir = "/content/drive/My Drive/models/chckPts/"
        ...
        self.loc_sd = 0.17  # std when setting the location
    ...
    def init_original(self):
        ...
        self.depth = 3  # number of zooms
        self.sensorBandwidth = 24
        self.minRadius = 15  # zooms -> minRadius * 2**<depth_level>
